  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='gongzuorenyuan'" class="input-group">
			   <div class="label">人员账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.renyuanzhanghao" class="input" type="text" placeholder="人员账号">
			   </div>
			 </div> -->
			<el-form-item label="人员账号" class="input" v-if="tableName=='gongzuorenyuan'">
			  <el-input v-model="ruleForm.renyuanzhanghao" autocomplete="off" placeholder="人员账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='gongzuorenyuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='gongzuorenyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='gongzuorenyuan'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<!-- <div v-if="tableName=='gongzuorenyuan'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.renyuanxingming" class="input" type="text" placeholder="人员姓名">
			   </div>
			 </div> -->
			<el-form-item label="人员姓名" class="input" v-if="tableName=='gongzuorenyuan'">
			  <el-input v-model="ruleForm.renyuanxingming" autocomplete="off" placeholder="人员姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='gongzuorenyuan'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='gongzuorenyuan'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='gongzuorenyuan'" class="input-group">
			   <div class="label">手机</div>
			...
			<el-form-item label="手机" class="input" v-if="tableName=='gongzuorenyuan'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.renyuanzhanghao) && `gongzuorenyuan` == this.tableName){
      ...
      if((!this.ruleForm.renyuanxingming) && `gongzuorenyuan` == this.tableName){
        this.$message.error(`人员姓名不能为空`);
        return
      }
      if(`gongzuorenyuan` == this.tableName && this.ruleForm.nianling&&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
        this.$message.error(`年龄应输入整数`);
        return
      }
      if(`gongzuorenyuan` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
      this.$http({
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20211113/47194b57629f4409a44788d0e550c24b.jpg);
